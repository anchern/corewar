		...
		t_sell *field)
{
	...
	c = 0;
	b = 0;
	result = 3; // (3 == константный сдвиг на 1 + байт для определения аргументов + первый байт определяющий номер регистра)
				// TODO: пересмотреть подсчет передвижения коретки в функциях где есть байт определение аргументов и константные аргументы
